...
async def setlg(client, message):
    ...
    if lg_code:
        ...
        try:
            ...
            await message.reply_text("❗️ This language Not available in My List \n Or Check Your spelling 😉", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Check List 📑", url="https://raw.githubusercontent.com/JohnWick000101/JohnWick_TranslatorBot/main/List/list.txt")]]))
            return
        set(user_id, lgcd)
