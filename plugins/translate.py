...
async def start(client, message):
    ...
    await message.reply_text(text=f"Hello **{message.from_user.first_name }** \n\n __I am a Translation assistant made by John Wick \n I can translate any language to your selected language__", reply_to_message_id=message.message_id, parse_mode="markdown", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Support 🇮🇳", url="https://t.me/John_Wick_0001")],                 [InlineKeyboardButton("Subscribe 🧐", url="https://www.youtube.com/channel/UCp5EA3dcr0hZ2oo-E2VPkbg")]]))
